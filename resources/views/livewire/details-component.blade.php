                                    ...
                                    <div class="detail-gallery">
                                        ...
                                        <div class="product-image-slider">
                                            <figure class="border-radius-10">
                                                <img src="{{asset('assets/imgs/products/')}}/{{$products->image}}" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="clearfix product-price-cover">
                                            <div class="product-price primary-color float-left">
                                                <ins><span class="text-brand">${{$products->regular_price}}</span></ins>
                                        ...
                                        <div class="detail-extralink">
                                            ...
                                            <div class="product-extra-link2">
                                                <button type="button" class="button button-add-to-cart" wire:click.prevent="store({{$products->id}},'{{$products->name}}',{{$products->regular_price}})" >Add to cart</button>
                                            ...
                                            <div class="product-cart-wrap small hover-up">
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="{{route('product.details',['slug',$reproduct->slug])}}" tabindex="0">
                                                            <img class="default-img" src="{{asset('assets/imgs/products/')}}/{{$reproduct->image}}" alt="">
                                                            <img class="hover-img" src="{{asset('assets/imgs/products/')}}/{{$reproduct->image}}" alt="">
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="product-content-wrap">
                                                    <h2><a href="{{route('product.details',['slug',$reproduct->slug])}}" tabindex="0">{{$reproduct->name}}</a></h2>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            <div class="single-post clearfix">
                                <div class="image">
                                    <img src="{{asset('assets/imgs/products/')}}/{{$products->image}}" alt="{{$nproduct->name}}">
                                </div>
