                        ...
                        <div class="shop-product-fillter">
                            ...
                            <div class="sort-by-product-area">
                                <div class="sort-by-cover mr-10">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            ...
                                            <li><a class="{{$pagesize == 25 ? 'active' : ''}}" href="#" wire:click.prevent="changePageSize(23)">25</a></li>
                                ...
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a class="{{$orderBy == 12 ? 'Defualt Sorting' : ''}}"  href="#" wire:click.prevent="changeOrderBy('Defualt Sorting')"">Defualt Sorting</a></li>
                                            <li><a class="{{$orderBy == 12 ? 'Price: Low to High' : ''}}" href="#" wire:click.prevent="changeOrderBy('Price: Low to High')"">Price: Low to High</a></li>
                                            <li><a class="{{$orderBy == 12 ? 'Price: High to Low' : ''}}" href="#" wire:click.prevent="changeOrderBy('Price: High to Low')"">Price: High to Low</a></li>
                                            <li><a class="{{$orderBy == 12 ? 'Sort By newness' : ''}}" href="#" wire:click.prevent="changeOrderBy('Sort By newness')"">Sort By newness</a></li>
                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="{{route('product.details',['slug' => $product->slug])}}">
                                                <img class="default-img" src="{{asset('assets/imgs/products/')}}/{{$product->image}}" alt="{{$product->image}}">
                                                <img class="hover-img" src="{{ asset('assets/imgs/shop/product-')}}{{$product->image}}-2.jpg" alt="{{$product->image}}">
                                            </a>
                                        </div>
                        ...
                        <div class="sidebar-widget price_range range mb-30">
                            ...
                            <div class="price-filter">
                                <div class="price-filter-inner">
                                    <div id="slider-range" wire:igonre></div>
