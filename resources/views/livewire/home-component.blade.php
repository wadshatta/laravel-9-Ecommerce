                        ...
                        <div class="row align-items-center slider-animated-1">
                            <div class="col-lg-5 col-md-6">
                                <div class="hero-slider-content-2">
                                    <h4 class="animated">{{$slides->top_title}}</h4>
                                    <h2 class="animated fw-900">{{$slides->title}}</h2>
                                    <h1 class="animated fw-900 text-brand">{{$slides->subtitle}}</h1>
                                    <p class="animated">Save more with coupons & up to {{$slides->offer}}off</p>
                                    <a class="animated btn btn-brush btn-brush-3" href="{{$slides->link}}"> Shop Now </a>
                                </div>
                            </div>
                            <div class="col-lg-7 col-md-6">
                                <div class="single-slider-img single-slider-img-1">
                                    <img class="animated slider-1-1" src="{{asset('assets/imgs/slider/')}}/{{$slides->image}}" alt="{{$slides->title}}">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="product-cart-wrap small hover-up">
                            <div class="product-img-action-wrap">
                                <div class="product-img product-img-zoom">
                                    <a href="{{route('product.details',['slug' => $nproduct->slug])}}">
                                        ...
                                        {{-- <img class="hover-img" src="{{asset('assets/imgs/products')}}/{{$nproduct->name}}" alt=""> --}}
                                    </a>
                                </div>
                                {{-- <div class="product-action-1">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <div class="product-price">
                                    ...
                                    <span class="old-price">${{$nproduct->sale_price}}</span>
                                </div>
                            </div>
                         </div>
                         @endforeach
