            ...
            <div class="container">
                <div class="header-wrap header-space-between position-relative">
                                ...
                                <ul>
                                    ...
                                    <li><a href="#">My Account<i class="fi-rs-angle-down"></i></a>
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="{{route('admin.home.slider')}}">Slide Manger</a></li>
                    ...
                    <div class="hotline d-none d-lg-block">
                        <p><i class="fi-rs-smartphone"></i><span>Toll Free</span> (+7) 99999999 </p>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            ...
                            <p class="wow fadeIn animated">
                                <strong>Phone: </strong>+7 99999999
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Email: </strong>contact@FoxStore.com
                            </p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p class="text-lg-end text-start font-sm text-muted mb-0">
                        &copy; <strong class="text-brand">FoxStore</strong> All rights reserved
                    </p>
                </div>
            </div>
        </div>
